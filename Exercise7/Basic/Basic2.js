function Basic2() {
    ...
    function constructChildTransformation(parent, translation) {
        ...
        let scaleTransform = document.createElement("transform");
        scaleTransform.setAttribute("scale", "0.333 0.333 0.333");
        scaleTransform.setAttribute("translation", translation);
        //scaleTransform.appendChild(translation);
        parent.appendChild(scaleTransform);
