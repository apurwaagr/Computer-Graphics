...
mat4.cameraMatrix = function (out, u, v, w, e) {
...
class Camera3D {
    ...
    update() {
        ...
        vec3.subtract(gaze, this.lookAtPoint, this.eye);
        let negativeGaze = vec3.create();
        vec3.negate(negativeGaze, gaze);
        vec3.normalize(this.w, negativeGaze);
        ...
        mat4.cameraMatrix(this.cameraMatrix, this.u, this.v, this.w, this.eye);
