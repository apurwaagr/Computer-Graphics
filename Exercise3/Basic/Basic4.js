...
function Basic4_1(canvas) {
    ...
    function Rotation(alpha) {
        ...
        return new LinearTransformation([1, -0.2, 0.2, 1]);
    }
    ...
    function Scaling(scale) {
        ...
        //			    code.
        return new LinearTransformation([0.5, 0, 0, 0.5]);
    }
    ...
    function ShearingX(shearX) {
        ...
        //			    appropriate code.
        return new LinearTransformation([1, 0.5, 0, 1]);
    }
...
function Basic4_2(canvas) {
    ...
    let triangle1 = new Triangle(ApplyLinearTransformation(ShearingX(-0.1), triangle.a), 
                                 ApplyLinearTransformation(ShearingX(-0.1), triangle.b), 
                                 ApplyLinearTransformation(ShearingX(-0.1),triangle.c));
    ...
    let triangle2 = new Triangle(ApplyLinearTransformation(ShearingY(0.2), triangle1.a), 
                                 ApplyLinearTransformation(ShearingY(0.2), triangle1.b), 
                                 ApplyLinearTransformation(ShearingY(0.2),triangle1.c));
    ...
    let triangle3 = new Triangle(ApplyLinearTransformation(ShearingX(-0.1), triangle2.a), 
                                 ApplyLinearTransformation(ShearingX(-0.1), triangle2.b), 
                                 ApplyLinearTransformation(ShearingX(-0.1),triangle2.c));
